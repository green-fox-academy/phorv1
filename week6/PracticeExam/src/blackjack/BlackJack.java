...
public class BlackJack {
  ...
  public static void main(String[] args) {
    ...
    // The constructor should fill the list with the number of different cards
    // using at least 4 different colors (except if the number given is smaller than four, than all cards should have different colors)
